...
import cn.common.util.Constant;
import cn.common.util.DateJsonValueProcessorUtil;
...
public class GenericActionSupport extends ActionSupport implements SessionAware, ServletRequestAware, ServletResponseAware{
    ...
    * */
    ...
    public String getConfigPath() {
        this.configPath= Constant.CONFIG_PATH;
        return ServletActionContext.getServletContext().getRealPath("/" + configPath);
    }
    ...
    public void writeJson(Object object) {
        try {
            ...
            ServletActionContext.getResponse().addHeader("Access-Control-Allow-Methods","PUT,POST,GET,DELETE,OPTIONS");
    ...
    public void writeJsonToMobile(Object object) {
        try {
    ...
    /**
     * @Enclosing_Method: getRealyPathe
     * @Description: 获取项目路径
     * @param path
     * @return
     */
